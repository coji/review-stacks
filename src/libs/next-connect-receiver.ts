...
import { HTTPModuleFunctions } from '@slack/bolt/dist/receivers/HTTPModuleFunctions'
...
export default class NextConnectReceiver implements Receiver {
  ...
  private async requestHandler(
    ...
    const event: ReceiverEvent = {
      ...
      retryNum: HTTPModuleFunctions.extractRetryNumFromHTTPRequest(req),
      retryReason: HTTPModuleFunctions.extractRetryReasonFromHTTPRequest(req),
